...
from .sm_reader import StochasticMnemonicReader
...
class DocReader(object):
    ...
    def __init__(self, args, word_dict, char_dict, feature_dict,
        ...
        elif args.model_type == 'stochastic_mnemonic':
            self.network = StochasticMnemonicReader(args, normalize)
        else:
