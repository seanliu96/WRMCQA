...
from wrmcqa.reader import utils, vector, config, data
from wrmcqa.reader import DocReader
from wrmcqa import DATA_DIR as WRMCQA_DATA
...
# Defaults
DATA_DIR = os.path.join(WRMCQA_DATA, 'datasets')
MODEL_DIR = '/tmp/WRMCQA-models/'
EMBED_DIR = os.path.join(WRMCQA_DATA, 'embeddings')
