            ...
            if p_words[idx:idx + len(a_words)] == a_words:
                ...
                if score > best_score:
                    ...
                    best_ex = {
                        ...
                        'qpos': q_tokens.pos(),
                        'qner': q_tokens.entities(),
                        'clemma': p_tokens.lemmas(),
                        'cpos': p_tokens.pos(),
                        'cner': p_tokens.entities(),
                    }
...
def process(questions, answers, outfile, opts):
    ...
    workers = Pool(opts['num_workers'], initializer=init,
...
if __name__ == "__main__":
    ...
    general.add_argument('--num-workers', type=int, default=int(cpu_count()/2))
