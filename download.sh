...
# All rights reserved.
# Copyright 2018-present, HKUST-KnowComp. All rights reserved.
# All rights reserved.
#
...
DOWNLOAD_PATH="$WRMCQA_DATA"
if [ "$WRMCQA_DATA" == "" ]; then
    echo "WRMCQA_DATA not set; downloading to default path ('data')."
    DOWNLOAD_PATH="./data"
fi
